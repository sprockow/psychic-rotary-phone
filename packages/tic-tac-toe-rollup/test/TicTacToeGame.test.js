...
describe('TicTacToeBoard', () => {
  describe('basic utils', () => {
    ...
    it('can getRow', () => {
      expect(ticTacUtils.getRow(samplePositions, 0)).toEqual([
        null,
        null,
        'PLAYER_X',
      ]);
    ...
    it('can getColumn', () => {
      expect(ticTacUtils.getColumn(samplePositions, 1)).toEqual([
        null,
        'PLAYER_0',
        'PLAYER_X',
      ]);
    ...
    it('can get top right diagonal', () => {
      expect(ticTacUtils.getTopRightDiagonal(samplePositions)).toEqual([
        'PLAYER_X',
        'PLAYER_0',
        null,
      ]);
    ...
    it('can get top left diagonal', () => {
      expect(ticTacUtils.getTopLeftDiagonal(samplePositions)).toEqual([
        null,
        'PLAYER_0',
        'PLAYER_0',
      ]);
    ...
    describe('not mutating board positions', () => {
      it('can create a copy of a row with a new position value', () => {
        ...
        const replacementRow = ticTacUtils.insertNewPositionIntoRow(
          row,
          0,
          'PLAYER_0',
        );
      ...
      it('can create an copy of the board with a new row', () => {
        ...
        const newPositions = ticTacUtils.insertNewRowIntoPositions(
  ...
  describe('can calculate winning player', () => {
    ...
    it('returns PLAYER_0 for diagonal win', () => {
      ...
      expect(ticTacUtils.getWinningPlayer(winningDiagonalBoard)).toEqual(
        'PLAYER_0',
      );
    });
    ...
    it('returns PLAYER_X for winningColumnBoard', () => {
      ...
      expect(ticTacUtils.getWinningPlayer(winningColumnBoard)).toEqual(
        'PLAYER_X',
      );
    });
  });
  ...
  describe('start game', () => {
    it('calling start game with no overrides', () => {
      ...
      expect(finalResults.positions).toEqual([
        ['PLAYER_0', 'PLAYER_X', 'PLAYER_X'],
        ['PLAYER_0', null, null],
        ['PLAYER_0', null, null],
      ]);
